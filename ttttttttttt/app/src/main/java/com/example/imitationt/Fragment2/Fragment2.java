...
import com.example.imitationt.Frament1.Fragment1to1;
...
public class Fragment2 extends Fragment {
    ...
    public static TextView bt1, bt2;
    @Override
    ...
    private void initFragment() {
        ...
        list.add(new Fragment2to1());
        list.add(new Fragment2to2());

        vp = view.findViewById(R.id.viewPager);               //获得ViewPager2控件
//设置预加载的Fragment页面数量，可防止流式布局StaggeredGrid数组越界错误。
    ...
    private void initClick() {
        ...
        //给新品选项添加点击事件
        bt1 = view.findViewById(R.id.choose1);
        ...
        bt2 = view.findViewById(R.id.choose2);
