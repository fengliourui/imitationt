    ...
    public void initViews(int[] resource) {
        ...
        for (int id : resource) {
            ...
            if (originalImages.size() == 1) {
                dotImageView.setImageResource(R.color.black);
            } else {
                dotImageView.setImageResource(R.color.white2);
            }
        ...
        viewPager2.registerOnPageChangeCallback(new ViewPager2.OnPageChangeCallback() {
            ...
            public void onPageSelected(int position) {
                ...
                for (int i = 0; i < mDotViewList.size(); i++) {
                    ...
                    if (i == position - 1) {
                        mDotViewList.get(i).setImageResource(R.color.black);
                    } else {
                        mDotViewList.get(i).setImageResource(R.color.white2);
                    }
                }
